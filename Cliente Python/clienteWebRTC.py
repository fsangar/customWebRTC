...
async def connect():
     ...
     ssl_context = ssl.SSLContext(ssl.PROTOCOL_TLSv2)
     ssl_context.check_hostname = False
     ssl_context.verify_mode = ssl.CERT_NONE

     ws = websocket.WebSocket(sslopt={"cert_reqs": ssl.CERT_NONE, "ssl_version": ssl.PROTOCOL_TLSv2})
     async with ws.connect("wss://servidor_wss.com", ssl_context=ssl_context):
